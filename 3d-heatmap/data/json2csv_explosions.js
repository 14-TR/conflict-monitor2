...
// Example usage
const inputFilePath = 'acled_data_explosions.json'; // Replace with your JSON file path
const outputFilePath = 'acled_data_explosions.csv'; // Replace with your desired CSV file path
